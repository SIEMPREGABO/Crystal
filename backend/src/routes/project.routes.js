...
import { getTasks, createTask, getTask, updateTask, deleteTask, createProject, obtenerMensajes, getProjects } from "../controllers/project.controller.js";
...
router.get('/getProjects',validarToken, getProjects);
